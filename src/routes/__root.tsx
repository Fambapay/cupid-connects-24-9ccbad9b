...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Flame — Encontre seu match" },
      ...
      { name: "apple-mobile-web-app-title", content: "Flame" },
      { property: "og:title", content: "Flame — Encontre seu match" },
      { property: "og:description", content: "Encontre matches e converse em tempo real." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Flame — Encontre seu match" },
