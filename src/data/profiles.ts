...
export const profiles: Profile[] = [
  {
    ...
    name: "Sofia",
    age: 26,
    bio: "Apaixonada por café, livros e pôr do sol na praia.",
    distance: "2 km",
    photo: p1,
    interests: ["☕ Café", "📚 Livros", "🌅 Pôr do sol"],
  },
  {
    id: "2",
    name: "Lucas",
    ...
    distance: "4 km",
    photo: p2,
    interests: ["🏄 Surf", "✈️ Viagens", "🎨 Design"],
  },
  {
    id: "3",
    name: "Marina",
...
export const conversations: Record<string, Message[]> = {
  m1: [
    ...
    { id: "2", text: "Oii Sofia! Tudo ótimo, e você?", fromMe: true, time: "10:05" },
