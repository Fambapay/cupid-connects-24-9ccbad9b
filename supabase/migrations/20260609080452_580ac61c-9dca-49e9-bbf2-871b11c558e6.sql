...
BEGIN
  ...
  -- Daily boost (Elite): SEM acumular — repõe ao valor diário sem reduzir se tiver mais.
  ...
  -- Weekly boost (Plus): aditivo, mas o cap (4) aplica-se só ao refill, NÃO ao balance total.
  -- Se o utilizador já tem >= 4 (ex: comprou pack), não recebe refill neste ciclo.
  -- Créditos comprados nunca são destruídos.
